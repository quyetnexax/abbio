...
const PrivacyPolicy = () => {
  return (
    <>
      <Helmet>
        <title>Privacy Policy - ABBIO</title>
        <meta
          name="description"
          content="Learn how ABBIO protects your privacy and handles your personal information. Our comprehensive privacy policy explains our data practices."
        />
        <meta property="og:title" content="Privacy Policy - ABBIO" />
        <meta property="og:description" content="Learn how ABBIO protects your privacy and handles your personal information." />
      </Helmet>
          ...
          <div className="section-container relative z-10">
            <div className="max-w-3xl">
              ...
              <p className="text-primary-foreground/80 text-lg md:text-xl max-w-2xl">
                At ABBIO, we believe in absolute transparency and respect your right to privacy. 
          ...
          <div className="section-container max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                ABBIO, being a professional technology company, strongly believes in your right to privacy 
            ...
            <div className="space-y-12">
              ...
              <section className="bg-card rounded-2xl p-8 border border-border/50">
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    At ABBIO, we only collect all this basic information purely for legitimate 
                ...
                <div className="space-y-4 text-muted-foreground">
                  <div className="bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-lg p-4">
                    ...
                    <p className="text-green-700 dark:text-green-300 mt-2">
                      As mentioned earlier, ABBIO is a professional technology company that believes 
                ...
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <div className="bg-yellow-50 dark:bg-yellow-950 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                    <p className="text-yellow-800 dark:text-yellow-200">
                      ...
                      ABBIO would never grant this permission on your behalf.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section className="bg-card rounded-2xl p-8 border border-border/50">
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    ABBIO strictly abides by privacy laws and never knowingly collects personal 
              ...
              <section className="bg-card rounded-2xl p-8 border border-border/50">
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    At ABBIO, we are as concerned about your privacy as you are. We always 
