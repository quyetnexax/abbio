...
const Index = () => {
  ...
  return (
    <>
      <Helmet>
        <title>ABBIO - Engineering Intelligence for the World</title>
        <meta 
          name="description" 
          content="ABBIO builds mobile and AI products that scale globally. Data-driven, design-led, results-focused. Creating world-class experiences for users around the world." 
        />
        <meta property="og:title" content="ABBIO - Engineering Intelligence for the World" />
        ...
        <meta name="twitter:title" content="ABBIO - Engineering Intelligence for the World" />
