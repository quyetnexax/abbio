      ...
      <div className="section-container section-padding">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-bold">ABBIO</span>
            </div>
            <p className="text-primary-foreground/70 mb-6 max-w-md leading-relaxed">
              ABBIO is a technology company focused on building global mobile and AI products. 
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3 text-primary-foreground/70">
                ...
                <span>ortizross4356636@gmail.com</span>
              </li>
              <li className="flex items-center gap-3 text-primary-foreground/70">
                <Phone size={18} className="text-primary" />
                <span>(+84) 0359082860</span>
              </li>
              <li className="flex items-start gap-3 text-primary-foreground/70">
                <MapPin size={18} className="text-primary mt-1" />
                <span>ABBIO XR INC.<br />1400 E Angela Blvd<br />South Bend, IN 46617-1364<br />United States</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-primary-foreground/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-primary-foreground/50 text-sm">
            © {new Date().getFullYear()} ABBIO. All rights reserved.
          </p>
